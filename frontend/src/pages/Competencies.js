                    ...
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
                        ...
                        <form onSubmit={handleSave} className="space-y-3">
                            <div>
                                ...
                                <input className="w-full border rounded-md px-3 py-2" value={formData.name} onChange={(e) => setFormData(p => ({ ...p, name: e.target.value }))} required />
                            </div>
                            <div>
                                <label className="text-sm font-medium">Level</label>
                                <input type="number" className="w-full border rounded-md px-3 py-2" value={formData.level} onChange={(e) => setFormData(p => ({ ...p, level: e.target.value }))} required />
                            </div>
                            <div>
                                <label className="text-sm font-medium">Institution</label>
                                <select className="w-full border rounded-md px-3 py-2" value={formData.institution_id} onChange={(e) => setFormData(p => ({ ...p, institution_id: e.target.value }))} required >
                            ...
                            <div>
                                ...
                                <select className="w-full border rounded-md px-3 py-2" value={formData.type_id} onChange={(e) => setFormData(p => ({ ...p, type_id: e.target.value }))} required >
                                    <option value="">Select...</option>
                            ...
                            <div>
                                ...
                                <select className="w-full border rounded-md px-3 py-2" value={formData.source_id} onChange={(e) => setFormData(p => ({ ...p, source_id: e.target.value }))} required >
                                    <option value="">Select...</option>
                            ...
                            <div>
                                ...
                                <textarea className="w-full border rounded-md px-3 py-2" rows={3} value={formData.evidence} onChange={(e) => setFormData(p => ({ ...p, evidence: e.target.value }))} />
                            </div>
                            <div className="flex justify-end gap-3 pt-2">
                                <button type="button" onClick={closeForm} className="px-4 py-2 rounded-md border border-gray-300 hover:bg-gray-100">Cancel</button>
